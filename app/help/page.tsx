...
export default function Help(){
  ...
  return (
    <div className="flex flex-row items-center w-[90%] ml-auto mr-auto h-[calc(100%-10rem)] bg-cover bg-[url(/scattered-forcefields2.svg)] dark:bg-[url(/scattered-forcefields2-dark.svg)]">
      <div className="w-[min(32rem,_100%)] mt-8 ml-auto mr-auto bg-primary dark:bg-primary-dark rounded-lg border-2 border-[rgb(203,_213,_224)] p-4">
        <div className="mt-2">
